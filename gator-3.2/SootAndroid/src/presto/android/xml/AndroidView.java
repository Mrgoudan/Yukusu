...
public class AndroidView implements IAndroidView {
  ...
  public IAndroidView deepCopy() {
    ...
    while (!work.isEmpty()) {
      ...
      tgt.resourceIdReference=src.resourceIdReference;
      tgt.resourceIdValue=src.resourceIdValue;
      tgt.textReference=src.textReference;
      tgt.textValue=src.textValue;
      tgt.imageReference=src.imageReference;
...
public String getResourceIdReference() {
	...
	public void setResourceIdReference(String resourceIdReference) {
