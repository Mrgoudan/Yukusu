...
public class DefaultXMLParser extends AbstractXMLParser {
  ...
  public HashMap<String, String> getStringIdValueMapping(){
	  return rStringAndStringValues;
  }
  ...
  public HashMap<String, String> getSysStringIdValueMapping(){
	  return sysRStringAndStringValues;
  }
  ...
  private Set<AndroidView> viewSet = new HashSet<AndroidView>();
  
  public  Set<AndroidView> getAndroidViewSet(){
	  return viewSet;
  }
...
//    assert Configs.project.equals(proj) ^ isSys;
  ...
  private void addPropertiesToView(AndroidView view, NamedNodeMap attrMap, String idReference, int idValue){
      //mf: handle all possible attributes that we need
      //mf: handle resource id
      if (idValue!=-1) {
        //System.out.println("reference:"+idReference);
        //System.out.println("id:"+idValue);
        view.setResourceIdReference(idReference);
        view.setResourceIdValue(idValue+"");
      }
      
      //mf: handle text (considering text as mutually exclusive)
      if(attrMap.getNamedItem("android:text")!=null){
    	  Node textNode = attrMap.getNamedItem("android:text");
          String reference = textNode.getTextContent();
          String text = convertReferenceToText(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("text:"+text);
          view.setTextReference(convertReferenceToString(reference));
          view.setTextValue(text);
      }
      else if(attrMap.getNamedItem("android:hint")!=null){
    	  Node hintNode = attrMap.getNamedItem("android:hint");
          String reference = hintNode.getTextContent();
          String hint = convertReferenceToText(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("hint:"+hint);
          view.setTextReference(convertReferenceToString(reference));
          view.setTextValue(hint);
      }
      else if(attrMap.getNamedItem("android:label")!=null){
    	  Node labelNode = attrMap.getNamedItem("android:label");
          String reference = labelNode.getTextContent();
          String label = convertReferenceToText(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("label:"+label);
          view.setTextReference(convertReferenceToString(reference));
          view.setTextValue(label);
      }
      else if(attrMap.getNamedItem("android:title")!=null){
    	  Node titleNode = attrMap.getNamedItem("android:title");
          String reference = titleNode.getTextContent();
          String title = convertReferenceToText(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("title:"+title);
          view.setTextReference(convertReferenceToString(reference));
          view.setTextValue(title);
      }
      else if(attrMap.getNamedItem("android:contentDescription")!=null){
    	  Node contentDescriptionNode = attrMap.getNamedItem("android:contentDescription");
          String reference = contentDescriptionNode.getTextContent();
          String contentDescription = convertReferenceToText(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("contentDescription:"+contentDescription);
          view.setTextReference(convertReferenceToString(reference));
          view.setTextValue(contentDescription);
      }
      else if(attrMap.getNamedItem("android:textOn")!=null){
    	  Node textOnNode = attrMap.getNamedItem("android:textOn");
          String reference = textOnNode.getTextContent();
          String textOn = convertReferenceToText(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("textOn:"+textOn);
          view.setTextReference(convertReferenceToString(reference));
          view.setTextValue(textOn);
      }
      else if(attrMap.getNamedItem("android:textOff")!=null){
    	  Node textOffNode = attrMap.getNamedItem("android:textOff");
          String reference = textOffNode.getTextContent();
          String textOff = convertReferenceToText(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("textOff:"+textOff);
          view.setTextReference(convertReferenceToString(reference));
          view.setTextValue(textOff);
      }
      
      //mf: handle image
      if(attrMap.getNamedItem("android:src")!=null){
    	  Node srcNode = attrMap.getNamedItem("android:src");
          String reference = srcNode.getTextContent();
          String convertedReference = convertDrawableReference(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("convertedReference:"+convertedReference);
          view.setImageReference(convertedReference);
      }
      if(attrMap.getNamedItem("app:srcCompat")!=null){
    	  Node srcNode = attrMap.getNamedItem("app:srcCompat");
          String reference = srcNode.getTextContent();
          String convertedReference = convertDrawableReference(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("convertedReference:"+convertedReference);
      ...
      else if(attrMap.getNamedItem("android:background")!=null){
    	  Node backgroundNode = attrMap.getNamedItem("android:background");
          String reference = backgroundNode.getTextContent();
          String convertedReference = convertDrawableReference(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("convertedReference:"+convertedReference);
          view.setImageReference(convertedReference);
      }
      else if(attrMap.getNamedItem("android:drawableLeft")!=null){
    	  Node drawableLeftNode = attrMap.getNamedItem("android:drawableLeft");
          String reference = drawableLeftNode.getTextContent();
          String convertedReference = convertDrawableReference(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("convertedReference:"+convertedReference);
          view.setImageReference(convertedReference);
      }
      else if(attrMap.getNamedItem("android:drawableRight")!=null){
    	  Node drawableRightNode = attrMap.getNamedItem("android:drawableRight");
          String reference = drawableRightNode.getTextContent();
          String convertedReference = convertDrawableReference(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("convertedReference:"+convertedReference);
          view.setImageReference(convertedReference);
      }
      else if(attrMap.getNamedItem("android:drawableTop")!=null){
    	  Node drawableTopNode = attrMap.getNamedItem("android:drawableTop");
          String reference = drawableTopNode.getTextContent();
          String convertedReference = convertDrawableReference(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("convertedReference:"+convertedReference);
          view.setImageReference(convertedReference);
      }
      else if(attrMap.getNamedItem("android:drawableBottom")!=null){
    	  Node drawableBottomNode = attrMap.getNamedItem("android:drawableBottom");
          String reference = drawableBottomNode.getTextContent();
          String convertedReference = convertDrawableReference(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("convertedReference:"+convertedReference);
          view.setImageReference(convertedReference);
      }
      else if(attrMap.getNamedItem("android:drawableStart")!=null){
    	  Node drawableStartNode = attrMap.getNamedItem("android:drawableStart");
          String reference = drawableStartNode.getTextContent();
          String convertedReference = convertDrawableReference(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("convertedReference:"+convertedReference);
          view.setImageReference(convertedReference);
      }
      else if(attrMap.getNamedItem("android:drawableEnd")!=null){
    	  Node drawableEndNode = attrMap.getNamedItem("android:drawableEnd");
          String reference = drawableEndNode.getTextContent();
          String convertedReference = convertDrawableReference(reference);
          //System.out.println("reference:"+reference);
          //System.out.println("convertedReference:"+convertedReference);
          view.setImageReference(convertedReference);
  ...
  private void readLayout(String file, AndroidView root, boolean isSys) {
    ...
    while (!work.isEmpty()) {
      ...
      //mf: add properties to node
      addPropertiesToView(view, attrMap, id, guiId);
      ...
      for (int i = 0; i < children.getLength(); i++) {
        ...
        if("tag".equals(nodeName)){
        	//ignore tags added by instrumentation
        	continue;
        }
...
*/
  ...
  String convertAndroidTextToString(String androidText) {
	...
	private String convertReferenceToText(String reference) {
		...
		if (reference.charAt(0) == '@') {
			if (reference.startsWith("@android:string/")) {
				return sysRStringAndStringValues.get(reference.substring("@android:string/".length()));
			}
			if (reference.startsWith("@*android:string/")) {
				return sysRStringAndStringValues.get(reference.substring("@*android:string/".length()));
			}
			if (reference.startsWith("@string/")) {
				String referenceName = reference.substring("@string/".length());
				String result = rStringAndStringValues.get(referenceName);
				if (result == null) {
					result = sysRStringAndStringValues.get(referenceName);
				}
				return result;
			}
			if (reference.startsWith("@id/")) {
				String referenceName = reference.substring("@id/".length());
			...
			System.err.println("can not handle reference to text: " + reference);
			System.exit(-1);
			return null;
		} else {
			return reference;
	...
	private String convertReferenceToString(String reference) {
		if (reference.isEmpty()) {
			return null;
		}
		// Is it string ref
		if (reference.charAt(0) == '@') {
			if (reference.startsWith("@android:string/")) {
				return reference.substring("@android:string/".length());
			}
			if (reference.startsWith("@*android:string/")) {
				return reference.substring("@*android:string/".length());
			}
			if (reference.startsWith("@string/")) {
				return reference.substring("@string/".length());
			}
			if (reference.startsWith("@id/")) {
				String referenceName = reference.substring("@id/".length());
				return referenceName;
			...
			System.err.println("can not handle reference to string: " + reference);
			System.exit(-1);
			return null;
		} else {
			return reference;
	...
	private String convertDrawableReference(String reference){
		...
		System.err.println("can not handle conversion of drawable reference " + reference);
		System.exit(-1);
		return null;
	}
  ...
  private void readStrings(String file, HashMap<Integer, String> idAndStrings,
    ...
    for (int i = 0; i < nodes.getLength(); i++) {
      ...
      //mf: logging
      //System.out.println("id:"+stringName+"#value:"+stringValue);
