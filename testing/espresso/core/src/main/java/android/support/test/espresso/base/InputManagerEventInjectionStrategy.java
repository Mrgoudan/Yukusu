  ...
  private boolean innerInjectMotionEvent(MotionEvent motionEvent, boolean shouldRetry)
    ...
    try {
      ...
      if((motionEvent.getSource() & InputDevice.SOURCE_CLASS_TRACKBALL) != 0){
        ...
        setSourceMotionMethod.invoke(motionEvent, InputDevice.SOURCE_TRACKBALL);
        //Log.d("Espresso", "here1");
      }
//      else if(motionEvent.getSource() == InputDevice.SOURCE_TOUCHSCREEN){
//        //mf: tried equivalent
//        //motionEvent.setSource(InputDevice.SOURCE_TOUCHSCREEN);
//        setSourceMotionMethod.invoke(motionEvent, InputDevice.SOURCE_TOUCHSCREEN);
//        //Log.d("Espresso", "here2");
//      }
      else if ((motionEvent.getSource() & InputDevice.SOURCE_CLASS_POINTER) == 0
