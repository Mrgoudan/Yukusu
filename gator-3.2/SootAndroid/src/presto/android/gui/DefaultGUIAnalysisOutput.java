...
public class DefaultGUIAnalysisOutput implements GUIAnalysisOutput {
  ...
  public Map<EventType, Set<SootMethod>> getSupportedEventsAndTheirHandlers(
    ...
    //mf: logging
    //System.out.println("View object:"+guiObject.toString());
    
    for (Stmt s : regs) {
      //mf: logging
      //System.out.println("Callback registration:"+s.toString());
      ...
      //mf: logging
      //for(SootMethod m:handlersToAdd){
    //	  System.out.println("Handler to add:"+m.toString()); 
      //}
