...
//    //mf: logging
//    System.out.println("Nodes#1:"+wtg.getNodes().size());
//    System.out.println("Edges#1:"+newEdges.entries().size());
...
//    //mf: logging
//    System.out.println("Nodes#2:"+wtg.getNodes().size());
//    System.out.println("Edges#2:"+newEdges.entries().size());
...
//	  //mf: logging
//	  System.out.println("XXXXXXXXXXXXXXbuildExplicitForwardEdgesXXXXXXXXXXXXXXXXXX");
  ...
  private Map<CFGAnalyzerInput, CFGAnalyzerOutput> analyzeCallback(
    ...
    /****************************************************************************/
//	//mf: logging
//	  System.out.println("XXXXXXXXXXXXXXanalyzeCallbackXXXXXXXXXXXXXXXXXX");
...
//            //mf: logging
//            System.out.println("analyzeCallback:view:"+view);
//            System.out.println("analyzeCallback:handler:"+handler);
//            System.out.println("analyzeCallback:widget:"+guiWidget);
  ...
  private void buildWTGEdges(
    ...
    //mf: logging
    //System.out.println("main class:"+mainClz);
    NActivityNode mainActNode = flowgraph.allNActivityNodes.get(mainClz);
    //mf: logging
    //System.out.println("main activity node:"+mainActNode);
    ...
    for (NObjectNode window : guiHierarchy.keySet()) {
      ...
      if (window instanceof NActivityNode) {
        ...
        if (om != null) {
          ...
          //mf: added
          callback = wtgHelper.getCallback(window.getClassType(),
                  MethodNames.sherlockOnCreateOptionsMenuSubsig);
          if (callback != null) {
              addHandlerBean(viewToHandlers, window, om, EventType.click, callback, false);
            }
        }
        ...
        if (window instanceof NContextMenuNode) {
          ...
          handlers = Lists.newArrayList(new String[] {
              ...
              MethodNames.sherlockOnOptionsItemSelectedSubSig,
              MethodNames.onMenuItemSelectedSubSig});
        }
  ...
  private void initializeGUIHierarchy(
    ...
    while (!windowNodeList.isEmpty()) {
      ...
      if (windowNode instanceof NActivityNode) {
        //mf: logging
        //System.out.println("Activity:"+windowNode.toString());
        
        SootClass actClass = ((NActivityNode) windowNode).c;
        NOptionsMenuNode optionMenu = guiOutput.getOptionsMenu(actClass);
        if (optionMenu != null) {
            //mf: logging
            //System.out.println("Options menu of activity:"+optionMenu.toString());
        ...
        for (NNode r : roots) {        	
            //mf: logging
            //System.out.println("Root of activity:"+r.toString());
          
          for (NNode desc : graphUtil.descendantNodes(r)) {        
        	  //mf: logging
              //System.out.println("Desc of root:"+desc.toString());
            ...
            for (NContextMenuNode cm : contextMenus) {
          	  //mf: logging
              //System.out.println("Context menu of desc:"+cm.toString());
      	  ...
      	  //mf: logging
          //System.out.println("Dialog:"+windowNode.toString());
    	  
        Set<NNode> all_roots = guiOutput.getDialogRoots((NDialogNode) windowNode);
        for (NNode r : all_roots) {
        	//mf: logging
            //System.out.println("Root of dialog:"+r.toString());
...
//    	  //mf: logging
//    	  if(windowNode instanceof NContextMenuNode){
//    		  System.out.println("Context menu:"+windowNode.toString());
//    	  }
//    	  else if (windowNode instanceof NOptionsMenuNode){
//    		  System.out.println("Options menu:"+windowNode.toString()); 
//    	  }
          
        for (NNode desc : graphUtil.descendantNodes(windowNode)) {
//        //mf: logging
//        if(windowNode instanceof NContextMenuNode){
//    		  System.out.println("Desc of context menu:"+desc.toString());
//    	  }
//    	  else if (windowNode instanceof NOptionsMenuNode){
//    		  System.out.println("Desc of options menu:"+desc.toString()); 
//    	  }
      ...
      if (nnode instanceof NActivityNode) {
        ...
        for (NWindowNode owner : menuToWindows.get(omNode)) {
          ...
          for (SootMethod callback : helper.getCallbacks(
              ...
              MethodNames.sherlockOnPrepareOptionsMenuSubsig,
