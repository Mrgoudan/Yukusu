...
public class IntentAnalysis {
  ...
  private void resolveApproximateIntent() {
    ...
    while (goOn) {
      //mf: logging
      //System.out.println("IntentAnalysis#Iteration");
      goOn = false;
  ...
  private void prepare() {
    ...
    for (Map.Entry<Expr, NAllocNode> entry : guiOutput.getFlowgraph().allNAllocNodes.entrySet()) {
      ...
      //mf: logging
      //System.out.println("IntentAnalysis#Intent allock:"+intentAllocNode);
      Set<NNode> reachedNodes = graphUtil.reachableNodes(intentAllocNode);
      for (NNode reachedNode : reachedNodes) {
    	  //mf: logging
    	  //System.out.println("IntentAnalysis#Reached node:"+reachedNode);
  ...
  private void resolveIntentTarget() {
    for (Map.Entry<NAllocNode, IntentAnalysisInfo> intentToInfo : intentContent.entrySet()) {
      ...
      if (explicitTargets.isEmpty() && Configs.implicitIntent) {
        ...
        for (NStartActivityOpNode startActivity : startActivities) {
          //mf: logging
//        	System.out.println("Start activity:"+startActivities);
//        	for(String target:explicitTargets){
//        		System.out.println("Explicit target:"+target);
//        	}
...
//	  //mf: logging
//	  System.out.println("resolvePreciseStartActivityTarget:widget:"+guiObj);
//	  System.out.println("resolvePreciseStartActivityTarget:handler:"+handler);
//	  for(Stmt ni:newIntentStmts){
//		  System.out.println("resolvePreciseStartActivityTarget:new intent stmt:"+ni);
//	  }
//	  for(Stmt si:setIntentStmts){
//		  System.out.println("resolvePreciseStartActivityTarget:set intent stmt:"+si);
//	  }
