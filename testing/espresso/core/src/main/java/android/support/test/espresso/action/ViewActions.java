...
public final class ViewActions {
  ...
  public static ViewAction click() {
    return actionWithAssertions(
            //mf: changed from VISIBLE_CENTER to CENTER
  ...
  public static ViewAction drawer(final int direction) {
    if(direction==1){
      //open drawer
      return actionWithAssertions(new GeneralSwipeAction(Swipe.FAST, GeneralLocation.CENTER_LEFT, GeneralLocation.CENTER_LEFT_WITH_DRAWER_OFFSET, Press.FINGER));//changed CENTER_RIGHT to CENTER_LEFT_WITH_OFFSET
    }
    else {
      //close drawer
      return actionWithAssertions(new GeneralSwipeAction(Swipe.FAST, GeneralLocation.CENTER_LEFT_WITH_DRAWER_OFFSET, GeneralLocation.CENTER_LEFT, Press.FINGER));
    }
  }


  public static ViewAction scroll(final int direction) {
    if(direction==0){
      //scroll up
      return actionWithAssertions(new GeneralSwipeAction(Swipe.FAST, GeneralLocation.TOP_CENTER, GeneralLocation.TOP_CENTER_WITH_OFFSET, Press.FINGER));
    }
    else if(direction==1){
      //scroll down
      return actionWithAssertions(new GeneralSwipeAction(Swipe.FAST, GeneralLocation.TOP_CENTER_WITH_OFFSET, GeneralLocation.TOP_CENTER, Press.FINGER));
    }
    else if(direction==2){
      //scroll left
      return actionWithAssertions(new GeneralSwipeAction(Swipe.FAST, GeneralLocation.CENTER_LEFT, GeneralLocation.CENTER_LEFT_WITH_OFFSET, Press.FINGER));
    }
    else if(direction==3){
      //scroll right
      return actionWithAssertions(new GeneralSwipeAction(Swipe.FAST, GeneralLocation.CENTER_LEFT_WITH_OFFSET, GeneralLocation.CENTER_LEFT, Press.FINGER));//double check
    }
    else {
  ...
  public static ViewAction swipe(final int direction) {
    if(direction==0){
      //swipe up
      return swipeUp();
    }
  ...
  //mf: search algorithm
  public static ViewAction search(Context appContext) {
    return actionWithAssertions(new Search(appContext));
  }

  //mf: sleep added
  public static ViewAction sleep(long millisDelay) {
    return actionWithAssertions(new Sleep(millisDelay));
  }

  //mf: sleep added
  public static ViewAction nothing() {
    return actionWithAssertions(new Nothing());
  }

  //mf: open options added (not really needed because we have menu key)
  public static ViewAction openOptions() {
    return actionWithAssertions(new OpenOptions());
  }

  //mf: rotate added
  public static ViewAction rotate() {
        return actionWithAssertions(new Rotate());
    }
}
