...
public interface MethodNames {
  ...
  //mf: added
  public String addHeaderViewName = "addHeaderView";
  ...
  //mf: added
  public String sherlockOnCreateOptionsMenuSubsig = "boolean onCreateOptionsMenu(com.actionbarsherlock.view.Menu)";
  public String sherlockOnPrepareOptionsMenuSubsig = "boolean onPrepareOptionsMenu(com.actionbarsherlock.view.Menu)";
  public String sherlockOnOptionsItemSelectedSubSig = "boolean onOptionsItemSelected(com.actionbarsherlock.view.MenuItem)";
  public String sherlockMenuInflaterSig = "<com.actionbarsherlock.view.MenuInflater: void inflate(int,com.actionbarsherlock.view.Menu)>";
