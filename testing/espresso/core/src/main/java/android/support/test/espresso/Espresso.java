...
public final class Espresso {
  ...
  //mf: changed to public
  public static final BaseLayerComponent BASE = GraphHolder.baseLayer();
  public static final IdlingResourceRegistry REGISTRY = BASE.idlingResourceRegistry();
